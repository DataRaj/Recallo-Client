...
function ChatSidebarImpl() {
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[12px] font-medium" style={{ color: '#FBF5DD' }}>In-meeting Chat</p>
        <button
          type="button"
      ...
      <div className="shrink-0 p-3" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        <div className="flex items-center gap-2 rounded-[9px] px-3 py-2" style={{ background: '#273338' }}>
          <input
            value={input}
