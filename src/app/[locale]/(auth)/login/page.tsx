    ...
    <div className="animate-fade-up w-full max-w-[420px]">
      ...
      >
        ...
        <button
          ...
          className="flex h-10 w-full items-center justify-center gap-2.5 rounded-[10px] text-sm font-medium transition-all duration-200 hover:opacity-90 active:scale-[0.97]"
          style={{
            background: '#18181b',
            color: '#fff',
          }}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <button
            ...
            className="mt-1 flex h-10 w-full items-center justify-center gap-2 rounded-[10px] text-sm font-medium text-white transition-all duration-200 hover:opacity-90 active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-50"
